...
fviz_pca_var(data.pca, col.var = "red", axes = 1:2) # dims 1 & 2
fviz_pca_var(data.pca, col.var = "red", axes = 3:4) # dims 3 & 4
fviz_pca_var(data.pca, col.var = "red", axes = 5:6) # dims 5 & 6
